...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gift_card_unique_id', models.CharField(default=giftcard.models.increment_giftcard_cnt, editable=False, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_type', models.CharField(choices=[('sms', 'SMS'), ('email', 'EMAIL'), ('address', 'address')], max_length=7)),
            ],
        ),
        migrations.CreateModel(
